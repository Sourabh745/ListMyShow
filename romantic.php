...
$data = file_get_contents("https://api.themoviedb.org/3/search/movie?api_key=af327102f938cc14497683c073a957ee&language=en-US&page=1&include_adult=false&query=$query&include_adult");

$data = json_decode($data, true);
echo "<pre>";
print_r($data);
echo "<center><h1>ROMANTIC MOVIES</h1></center>";
