...
$data = file_get_contents("https://api.themoviedb.org/3/movie/top_rated?api_key=af327102f938cc14497683c073a957ee&language=en-US&page=1");

$data = json_decode($data, true);
echo "<pre>";
//print_r($data);
echo "<center><h1>TOP RATED MOVIES</h1></center>";
